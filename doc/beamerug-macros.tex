...
\def\package#1{\BlockClass{package}\BlockClass{package-headline}\list{}{\leftmargin=2em\itemindent-\leftmargin\def\makelabel##1{\hss##1}}%
  \extracttheme#1@usepackage@package@Packages@\par\topsep=0pt\endBlockClass}
